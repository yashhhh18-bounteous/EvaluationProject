...
export default function LoginPage() {
  ...
  const validate = () => parseErrors(loginSchema, { email, password })
      ...
      <div className="relative hidden lg:flex w-[55%] flex-col justify-between p-14 overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <h1 className="text-[clamp(52px,5.5vw,82px)] font-light leading-[0.95] text-[#f5f0eb]"
            ...
            Shop<br />with<br />
            <em className="font-normal text-[#059669]" style={{ fontStyle: "italic" }}>intention.</em>
          </h1>
        ...
        <div className="relative z-10 space-y-6">
          <div className="space-y-3.5">
            {["Lightning fast product discovery", "Personalized shopping experience", "Modern full-stack architecture"].map((feat) => (
              <div key={feat} className="group flex items-center gap-3.5 text-[13px] font-light text-[#f5f0eb]/40 transition-colors duration-300 hover:text-[#f5f0eb]/80">
                <div className="h-1.5 w-1.5 flex-shrink-0 rounded-full bg-[#059669]" />
                {feat}
              </div>
            ))}
          </div>
      ...
      <div className="relative flex flex-1 items-center justify-center bg-[#faf7f3] px-6 py-12">
        ...
        <div className="w-full max-w-[390px] space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="space-y-1">
            <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-[#059669]">Welcome back</p>
            <h2 className="text-[42px] font-light leading-tight text-[#0a0a0f]"
              style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              Sign <em style={{ fontStyle: "italic" }}>in</em>
            </h2>
            <p className="text-[13px] font-light text-[#8a7f78]">Continue your shopping journey</p>
          </div>
          ...
          <Card className="border border-[#e8e3dd] bg-white shadow-xl shadow-[#059669]/5 rounded-2xl">
            <CardContent className="p-6 space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                {fieldError("email") && (
                  <p className="text-[11px] text-red-400 font-light">{fieldError("email")}</p>
                )}
              </div>
              ...
              <div className="space-y-1.5">
                ...
                {fieldError("password") && (
                  <p className="text-[11px] text-red-400 font-light">{fieldError("password")}</p>
                )}
              </div>
          ...
          <p className="text-center text-[13px] font-light text-[#8a7f78]">
            ...
            <Link href="/signup" className="font-medium text-[#059669] underline-offset-4 hover:underline transition-all">
              Create one
            </Link>
          </p>
        </div>
